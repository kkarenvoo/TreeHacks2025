...
export default function Home() {
  ...
  return (
    <AnimatePresence>
      <div className="min-h-screen w-screen flex flex-col bg-gray-900 text-white font-inter overflow-hidden relative">
        {/* Animated background */}
        ...
        {/* Cursor follower */}
        <motion.div
          className="hidden sm:block w-64 h-64 rounded-full bg-blue-500 opacity-10 pointer-events-none"
          style={{
            position: 'fixed',
            zIndex: 0,
        ...
        <main className="flex-grow flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <motion.div 
              className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-8 mb-12"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4, duration: 0.8 }}
            >
              <div className="bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-700">
                <h2 className="text-xl font-semibold text-blue-400 mb-2">Platform</h2>
                <p className="text-gray-300">
                  Full access to our platform, including all questions and solutions.
                </p>
              </div>
              <div className="bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-700">
                <h2 className="text-xl font-semibold text-blue-400 mb-2">Community</h2>
                <p className="text-gray-300">
                  Master coding through real-time AI pair programming.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <Link
                href="/demo"
                className="inline-flex items-center justify-center px-6 py-3 border border-blue-500 text-base font-medium rounded-md text-blue-400 bg-transparent hover:bg-blue-900 transition-colors duration-300"
              >
                Try Demo
              </Link>
            </motion.div>
